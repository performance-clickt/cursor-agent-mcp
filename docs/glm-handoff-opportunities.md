...
> This document is the project **brief**. It is the source of the Linear project
> [Cursor MCP](https://linear.app/clickt/project/cursor-mcp-f6d508e22579); each issue
> (HM-557 – HM-570) maps to a section below (§0–§7).
